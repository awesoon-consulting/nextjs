        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-6">
            <Link
              ...
              className="text-sm text-neutral-400 hover:text-text-inverse transition-colors flex items-center gap-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded"
            >
          ...
          <h1 className="font-heading font-bold text-4xl sm:text-5xl text-text-inverse mb-4 leading-tight">
