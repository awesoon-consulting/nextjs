...
export default function CookieBanner({ onManage }: CookieBannerProps) {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl rounded-2xl border border-neutral-200 bg-white p-5 shadow-[0_24px_80px_rgba(10,10,10,0.18)] sm:p-6 dark:border-white/10 dark:bg-primary dark:shadow-xl">
