 ...
 * @readme   ./README.md
 * @purpose  Interactive colorful platform badges for solution/support pages.
 *           Grid is primary (wide 4-col), detail card sits above as a horizontal
 *           strip that's always visible. Tap a logo -> detail updates instantly.
...
export default function PlatformStack({
  ...
  return (
    <div>
      ...
      {/* Detail strip: always visible, updates on logo tap */}
      <div
        key={active}
        className="mb-4 rounded-2xl border border-neutral-200 bg-gradient-to-br from-white to-neutral-50 p-5 shadow-sm dark:border-white/10 dark:from-white/[0.04] dark:to-white/[0.02]"
        aria-live="polite"
      >
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0 flex h-16 w-16 items-center justify-center rounded-xl bg-white border border-neutral-200 shadow-sm dark:bg-white dark:border-white/20">
      ...
      >
        {platforms.map((platform, i) => {
          ...
          return (
            ...
            >
              {/* White tile for logo so brand colors always have contrast, even in dark mode */}
              ...
              <span
                className={[
                  'pointer-events-none text-[11px] font-semibold leading-none truncate w-full text-center transition-colors',
                  isActive
