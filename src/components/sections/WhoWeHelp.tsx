        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {industries.map((industry, idx) => (
            <AnimateIn key={industry} variant="slide-up" delay={idx * 80} threshold={0.05}>
              <div className="group h-full p-8 rounded-2xl border border-neutral-200 dark:border-white/10 bg-white dark:bg-white/5 hover:border-accent/50 dark:hover:border-accent/40 hover:shadow-lg dark:hover:bg-white/10 transition-all duration-300 cursor-default">
