...
export const solutions: SolutionData[] = [
  ...
  },
  {
    ...
    ctaText: 'Get a Free Systems Health Check',
    ...
    translations: {
      fr: {
        ...
        ctaText: 'Obtenir un bilan gratuit des systèmes',
      },
      es: {
        ...
        ctaText: 'Obtén un diagnóstico gratuito de sistemas',
      },
    },
  },
  {
  ...
  },
  {
    ...
    category: 'Strategy',
    seoSummary:
      'Operational systems health check for companies that need a clear roadmap across ERP, integrations, spreadsheets, and AI readiness.',
    painPoints: [
    ...
    ctaText: 'Book a Systems Health Check',
    ...
    translations: {
      fr: {
        ...
        category: 'Stratégie',
        seoSummary: 'Bilan des systèmes opérationnels pour les entreprises qui ont besoin d’une feuille de route claire sur ERP, intégrations, feuilles de calcul et préparation IA.',
        ...
        ctaText: 'Réserver un bilan des systèmes',
      },
      es: {
        problemHeadline: 'No sabes por dónde empezar',
        category: 'Estrategia',
        seoSummary: 'Diagnóstico de sistemas operativos para empresas que necesitan una hoja de ruta clara sobre ERP, integraciones, hojas de cálculo y preparación para IA.',
        ...
        ctaText: 'Reserva un diagnóstico de sistemas',
      },
    },
  },
  {
